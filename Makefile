...
project = Sengmillner_Quis_Deus_magnus
notes = vl1 vl2 vla1 vla2 S A T B org
scores = full_score vl1 vl2 vla1 vla2 coro b org
...
archive:
	zip $(zipname).zip README.md LICENSE.txt Makefile *.ly \
	notes/*.ly scores/*.ly \
